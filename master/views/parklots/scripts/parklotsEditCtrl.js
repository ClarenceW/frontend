...
angular.module('parkingApp').controller('ParklotsEditCtrl', function ($rootScope, $scope, $http, $state, growl, Setting, parklotsService,sessionCache,StateName,Upload,$timeout) {
    ...
    function fillForm(dto) {
        $scope.formData.code = $state.params.code;
        ...
        if(dto.pic1) {
          ...
          $scope.formData.picUrl1 = $scope.formData.default;
        }
        if(dto.pic2) {
          $scope.formData.pic2 = dto.pic2;
          $scope.formData.picUrl2 = Setting.SERVER.DOWNLOAD+"?file="+dto.pic2;
        }else {
          $scope.formData.picUrl2 = $scope.formData.default;
        }
        ...
        $scope.formData.ruleDesc = dto.ruleDesc;
    ...
    $scope.openMap = function ($event) {
        ...
        if ($scope.formData.lng && $scope.formData.lat) {
            ...
            map.panTo([$scope.formData.lng, $scope.formData.lat]);
        }
