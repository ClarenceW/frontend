...
angular.module('parkingApp').controller(
	'ParklotsAddCtrl', function ($rootScope, $scope, $http,Setting, $state, growl, parklotsService,sessionCache,StateName,companyService,Upload,$timeout) {

    var indexId = "#parklotAdd";
    ...
    $scope.submitForm = function (isValid) {
      $scope.submited = true;
        if (isValid) {
            parklotsService.reqAddParkLot($scope.formData).then(function (msg) {
