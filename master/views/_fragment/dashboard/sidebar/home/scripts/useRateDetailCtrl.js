'use strict';
angular.module('parkingApp').controller('HomeUserRateCtrl', ['$scope', '$state', 'StateName', 'sessionCache', 'Setting', 'homeService', '$compile', 'customerService','$filter','parklotsService','$timeout','growl',
  function ($scope, $state, StateName, sessionCache, Setting, homeService, $compile, customerService,$filter,parklotsService,$timeout,growl) {
    ...
    function detailTable(data) {
      homeService.reqBerthUseDetail(data).then(resp => {
    ...
    function showChartBerthRate(array1, obj1,obj2,obj3) {debugger
      let dom = document.getElementById('BerthUseRateDetail');
    ...
    function showChartBerthRate2(array1, obj1,obj2,obj3) {debugger
      let dom = document.getElementById('BerthUseRateDetail');
      let myChart = echarts.init(dom);
      let option = {
        title: {
