'use strict';
angular.module('parkingApp').controller('SectionAddCtrl', function ($rootScope, $scope, $http, $state, growl, Setting, $log, sectionService, StateName, sessionCache) {

    var indexId = "#sectionAddIndex";
    ...
    $scope.submitForm = function (isValid) {
        if (isValid) {
            sectionService.addSection($scope.formData).then(function (resp) {
                if (resp && resp.data)
